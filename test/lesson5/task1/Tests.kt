...
class Tests {
    ...
    fun averageStockPrice() {
        ...
        assertEquals(
            mapOf("MSFT" to 160.0, "NFLX" to 45.0),
            averageStockPrice(listOf("MSFT" to 100.0, "MSFT" to 200.0, "MSFT" to 20.0, "NFLX" to 40.0, "NFLX" to 50.0))
        )
    }
    ...
    fun findSumOfTwo() {
        ...
        assertEquals(
            Pair(0, 5),
            findSumOfTwo(listOf(0, 3, 3, 8, 5, 0, 4), 0)
        )
        assertEquals(
            Pair(-1, -1),
            findSumOfTwo(listOf(0, 3, 3, 8, 5, 0, 4), -5)
        )
        assertEquals(
            Pair(0, 1),
